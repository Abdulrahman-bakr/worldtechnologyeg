...
const Footer = ({ storeSettings }) => {
    ...
    return (
        React.createElement("footer", { 
            id: "footer", 
            className: "bg-light-100 dark:bg-dark-800 py-12 sm:py-16 border-t border-light-200 dark:border-dark-700" 
        },
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8" },
                ...
                React.createElement("div", { 
                    className: "border-t border-light-300 dark:border-dark-600 mt-8 pt-8 text-center text-sm text-dark-700 dark:text-dark-200" 
                },
