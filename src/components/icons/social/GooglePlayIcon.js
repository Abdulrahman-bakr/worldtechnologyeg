/**
 * أيقونة Nintendo Switch (Multi-Color)
 * يتم تصديرها كمكوّن Component للحفاظ على الألوان الأصلية.
 * يمكنك استبدال 'fill' بـ 'currentColor' إذا أردت التحكم باللون عبر CSS
 * لكننا سنبقي الألوان الأصلية للحفاظ على التصميم.
 */
export const GooglePlayIcon = ({ size = '24', color = 'currentColor', ...props }) => (
  <svg 
    viewBox="-9 0 274 274" 
    width={size} 
    height={size} 
