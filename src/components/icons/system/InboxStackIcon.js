...
// الألوان الافتراضية
const DEFAULT_BASE_COLOR = "#8FCAE6"; // اللون الأساسي (كان أسود)
const DEFAULT_ACCENT_COLOR = "#33a867"; // اللون الثانوي (الأخضر)

export const InboxStackIcon = ({
    className = "",
    size = 24,
    style = {},
    baseColor = DEFAULT_BASE_COLOR,   // <-- prop جديد للتحكم في اللون الأساسي
    accentColor = DEFAULT_ACCENT_COLOR, // <-- prop جديد للتحكم في اللون الأخضر
    ...restProps
}) => {
    return (
        <svg
