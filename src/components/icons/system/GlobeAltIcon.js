...
// المكون الوظيفي الذي يعرض الأيقونة الجديدة (أيقونة السفر/الكرة الأرضية المفصلة) مباشرةً
export const GlobeAltIcon = ({
    className = "",
    size = 24, // الحجم الافتراضي
    color = "currentColor", // سيتم استخدام هذا اللون لتعبئة الأيقونة (لأنها fill-based)
    style = {},
    ...restProps
}) => {
    return (
        <svg
            ...
            // يتم تحويل xmlns:xlink إلى camelCase
