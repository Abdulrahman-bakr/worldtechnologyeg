...
// تعريف المكون الوظيفي لعرض الأيقونة الأصلية ذات الألوان المتعددة (العلم/الجوائز)
export const OriginalIcon = ({
    className = "",
    size = 64, // الحجم الافتراضي
    style = {},
    ...restProps
}) => {
    return (
