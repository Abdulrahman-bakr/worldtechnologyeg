...
// المكون الوظيفي الذي يعرض الأيقونة الجديدة (Realtime/Performance) مباشرةً
export const BoltIcon = ({
    className = "",
    size = 24, // الحجم الافتراضي
    color = "currentColor", // سيتم استخدام هذا اللون لتعبئة الأيقونة
    style = {},
    ...restProps
}) => {
    return (
        <svg 
            ...
            style={{
                ...
                // يمكن إضافة خصائص خاصة هنا إذا لزم الأمر
                ...style,
            }}
            {...restProps}
        >
