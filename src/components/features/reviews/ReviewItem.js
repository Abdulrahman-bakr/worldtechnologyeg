...
const ReviewItem = ({ review }) => {
    ...
    return React.createElement("div", { className: "border-b border-light-200 dark:border-dark-700 pb-6" },
        React.createElement("div", { className: "flex items-center mb-2" },
            React.createElement("p", { className: "font-semibold text-dark-900 dark:text-dark-50 mr-4" }, review.userName),
            React.createElement(StarRating, { rating: review.rating })
        ),
        review.createdAt && React.createElement("p", { className: "text-xs text-dark-600 dark:text-dark-300 mb-3" }, formatTimeAgo(review.createdAt)),
