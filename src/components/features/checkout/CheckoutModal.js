...
const CheckoutModal = ({ 
  ...
  return React.createElement("div", {
    ...
    React.createElement("div", { className: `modal-overlay absolute inset-0 bg-black/85 transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0'}`, onClick: handleOverlayClick, "aria-hidden": "true" }),
    React.createElement("div", { className: `modal-content bg-white dark:bg-dark-800 rounded-xl shadow-2xl p-4 sm:p-6 w-full max-w-xl relative ${contentAnimation} border border-light-200 dark:border-dark-700 max-h-[90vh] flex flex-col` },
      ...
      React.createElement("div", { className: "overflow-y-auto pr-1 sm:pr-2 flex-grow space-y-4" },
        React.createElement(Suspense, { fallback: React.createElement("div", { className: "text-center p-8 text-dark-700 dark:text-dark-200" }, "جاري تحميل...") },
