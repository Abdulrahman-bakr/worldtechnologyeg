...
// --- START OF WishlistView.tsx ---
const WishlistView = ({ wishlistProducts, onAddToCart, onViewDetails, onBack, onLoginRequest, currentUser, onToggleWishlist, wishlistItems, onNavigate }) => {
    // const isProductInWishlist = (productId) => wishlistItems.includes(productId); // Already passed as true for items here
            ...
            React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" },
                wishlistProducts.map(product =>
                    React.createElement(ProductCard, {
                        ...
                        isInWishlist: true, // Items in WishlistView are always in wishlist
